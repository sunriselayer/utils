...
if [ "$execute_command" = "init" ]; then
  ...
  if (( major_version > 0 || minor_version >= 47 )); then
    ...
    $DAEMON_NAME genesis add-genesis-account $($DAEMON_NAME keys show $USER1 --keyring-backend test -a) 1000000000000uvrise,1000000000000urise,100000000000000000ibc/uusdc,100000000000000000ibc/uusdt,100000000000000000ibc/uatom,100000000000000000ibc/stuatom,1000000000000000ibc/uweth,100000000000000000000000ibc/ushib,100000000000000000000ibc/uibgt,100000000000000000000ibc/uoas,100000000000000000000000ibc/upepe;
